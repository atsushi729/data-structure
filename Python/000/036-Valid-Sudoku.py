...
def is_valid_sudoku(board: list[list[str]]) -> bool:
    ...
    #         self.assertEqual(is_valid_sudoku([["5", "3", ".", ".", "7", ".", ".", ".", "."],
    #                                           ["6", ".", ".", "1", "9", "5", ".", ".", "."],
    #                                           [".", "9", "8", ".", ".", ".", ".", "6", "."],
    #                                           ["8", ".", ".", ".", "6", ".", ".", ".", "3"],
    #                                           ["4", ".", ".", "8", ".", "3", ".", ".", "1"],
    ...
    #                                           [".", ".", ".", ".", "8", ".", ".", "7", "9"]]), True)
    #
    #         self.assertEqual(is_valid_sudoku([["8", "3", ".", ".", "7", ".", ".", ".", "."],
    #                                           ["6", ".", ".", "1", "9", "5", ".", ".", "."],
    #                                           [".", "9", "8", ".", ".", ".", ".", "6", "."],
    #                                           ["8", ".", ".", ".", "6", ".", ".", ".", "3"],
    #                                           ["4", ".", ".", "8", ".", "3", ".", ".", "1"],
    ...
    #                                           [".", ".", ".", ".", "8", ".", ".", "7", "9"]]), True)
    #
    #     def test_is_valid_sudoku_model(self):
    #         self.assertEqual(is_valid_sudoku_model([["5", "3", ".", ".", "7", ".", ".", ".", "."],
    #                                                 ["6", ".", ".", "1", "9", "5", ".", ".", "."],
    #                                                 [".", "9", "8", ".", ".", ".", ".", "6", "."],
    #                                                 ["8", ".", ".", ".", "6", ".", ".", ".", "3"],
    #                                                 ["4", ".", ".", "8", ".", "3", ".", ".", "1"],
